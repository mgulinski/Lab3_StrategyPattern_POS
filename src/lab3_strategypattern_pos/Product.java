...
public class Product {
	...
	Product myproduct = new Product("100", "Toilet Paper", new VariableQtyDiscount());
	
	myproduct.discount.setDiscountRate(0.1);
	
	System.out.println("Todays discount for " + myproduct.productName + " is: " + myproduct.discount.getDiscountAmt(1, 5));
